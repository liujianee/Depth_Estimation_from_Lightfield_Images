...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        param.smooth_func      = @rcos;                % smooth function for Laplacian Pyramid
        param.Pyr_mode         = 2;                    % redundancy setting for the transformed coefficients
        ...
        param.beta             = 2e-3;                 % regulization parameter for total variation term 
        param.max_itr          = 80;                  % maximum iteration for reconstruction
        param.tol              = 1e-5;                 % tolerance for stop condition
        param.disp_relchg      = 0;                    % display the relative change during process
        param.disp_img         = 1;                    % display image during process
        % scale setting
        Q                      = 2;                    
        [D, ~]            = defDDt;
